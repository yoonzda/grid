      ...
      },
      {
        ...
        elements: [
          ...
          },
          {
            ...
            gridY: 3,
            gridH: 3,
            content: '12컬럼 플랙서블 시스템을 도입하여 디바이스에 관계 없이 완벽히 뻗어나갑니다.',
            color: 'var(--theme-text)',
            fontSize: '12px',
            fontFamily: 'Inter',
            align: 'center',
          ...
          },
          {
            ...
            gridY: 3,
            gridH: 3,
            content: '스타일 가이드를 단 한 번 수정하는 것으로 사이트 내 모든 요소를 갱신합니다.',
            color: 'var(--theme-text)',
            fontSize: '12px',
            fontFamily: 'Inter',
            align: 'center',
          ...
          },
          {
            ...
            gridY: 3,
            gridH: 3,
            content: '압축 해제 후 즉시 배포가 가능한 표준 HTML과 CSS로 패키징하여 내보냅니다.',
            color: 'var(--theme-text)',
            fontSize: '12px',
            fontFamily: 'Inter',
            align: 'center',
...
const getModernHeader = (): Section => ({
  ...
  headerBtnText: '컨택트',
  headerBtnBgColor: 'var(--theme-primary)',
  headerBtnTextColor: '#ffffff',
  headerBtnRadius: 20,
  headerGap: 40,
  headerMenuGap: 24,
