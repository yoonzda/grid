...
const getBusinessFooter = (): Section => ({
  ...
  footerCompany: '(주) 널리아이 / 마춤드림센터',
  footerRepresentative: '이중선',
  footerAddress: '인천광역시 미추홀구 인주대로 147, 2~3층(용현동)',
  footerTel: '032-751-1199',
  footerBizNum: '346-85-02027',
  footerLinksText: '개인정보처리방침   직원로그인',
  footerCopyright: 'Copyright © Macum Dream Center. All rights reserved.',
  footerShowChannelBadge: true,
...
const getModernFooter = (): Section => ({
  ...
  footerRepresentative: 'Yoon ZDA',
  footerAddress: 'Seoul, Gangnam-gu, Dosan-daero 88, Studio 3F',
  footerTel: '02-1234-5678',
  footerBizNum: '987-65-43210',
  footerLinksText: 'Privacy Policy   Terms of Service   Staff Login',
  footerCopyright: 'Copyright © MODERN STUDIO. All rights reserved.',
  footerShowChannelBadge: true,
