...
export const MEDICAL_THEME: ThemeSettings = {
  ...
  fontPresets: [
    ...
    { id: 'menu', name: '네비게이션 메뉴', fontSize: '14px', fontFamily: 'Inter', fontWeight: '500', color: 'var(--theme-text-inverse)' },
...
export const MEDICAL_TEMPLATE: Page[] = [
  {
    ...
    sections: [
      ...
      // Section 1: Hero Main Visual (메인 비주얼 - 스태틱 대표 비주얼 & 3열 안내)
      {
        ...
        backgroundImage: 'https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=1600&auto=format&fit=crop&q=80',
        ...
        elements: [
          ...
          },
          {
            ...
            col1Text: '환자의 입장에서 먼저 생각합니다.',
            col1Icon: 'home',
            col2Title: '정직한 진단',
            col2Text: '과잉진료 없이 바른 진료를 약속합니다.',
            col2Icon: 'mail',
            col3Title: '신뢰를 이어가는 치과',
            col3Text: '오래도록 믿고 찾을 수 있는 치과가 되겠습니다.',
            col3Icon: 'phone',
