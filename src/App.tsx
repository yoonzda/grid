    ...
    sections: p.sections.map(sec => {
      ...
      if (sec.sharedType === 'footer') {
        return {
          ...
          footerCompany: sec.footerCompany || '(주) 널리아이 / 마춤드림센터',
          footerRepresentative: sec.footerRepresentative || '이중선',
          footerAddress: sec.footerAddress || '인천광역시 미추홀구 인주대로 147, 2~3층(용현동)',
          footerTel: sec.footerTel || '032-751-1199',
          footerBizNum: sec.footerBizNum || '346-85-02027',
          footerLinksText: sec.footerLinksText || '개인정보처리방침   직원로그인',
          footerCopyright: sec.footerCopyright || 'Copyright © Macum Dream Center. All rights reserved.',
